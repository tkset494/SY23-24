...
Partial Class ReelControl1
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(0, "bar.jpeg")
        Me.ImageList1.Images.SetKeyName(1, "jackpot.jpeg")
        Me.ImageList1.Images.SetKeyName(2, "Gambling3.Jpeg")
        Me.ImageList1.Images.SetKeyName(3, "Gambling2.Jpeg")
        Me.ImageList1.Images.SetKeyName(4, "Gambling.Jpeg")
        '
        'PictureBox1
        '
